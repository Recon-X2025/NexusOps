...
| **2.4** | 2026-04-07 | **Repeatable Class P execution:** **`pnpm test:class-p`** → **`scripts/run-class-p-tests.sh`** (`layer8-module-smoke` + `grc-rbac` · `csm-rbac` · `hr-crm-rbac` · `serial-longtail-rbac` + **`e2e/module-routes.spec.ts`** + **`e2e/grc|csm|hr|crm.spec.ts`**). |
