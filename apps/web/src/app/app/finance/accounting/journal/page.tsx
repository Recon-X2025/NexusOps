    ...
    return (
        <div className="flex flex-col gap-6 p-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-h3 font-bold text-foreground">Journal Entries</h1>
                    <p className="text-body-sm text-muted-foreground mt-1">Record and manage your manual journal entries.</p>
                </div>
            ...
            {isCreating ? (
                <div className="bg-card border border-border rounded-xl p-6 space-y-6 animate-in fade-in slide-in-from-top-4 duration-300">
                    <div className="flex items-center justify-between border-b border-border pb-4">
                        <h2 className="text-body-lg font-bold">New Journal Entry</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <label className="text-caption font-bold text-muted-foreground uppercase tracking-widest">Subject / Narration</label>
                            <input
                                type="text"
                                placeholder="e.g. Monthly Rent Payment"
                                value={subject}
                                onChange={(e) => setSubject(e.target.value)}
                                className="w-full px-4 py-2 bg-muted/50 border border-border rounded-lg text-body-sm focus:ring-1 focus:ring-primary outline-none"
                            />
                        </div>
                        <div className="space-y-2">
                            <label className="text-caption font-bold text-muted-foreground uppercase tracking-widest">Date</label>
                            <input
                                type="date"
                                value={date}
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-12 gap-4 px-2">
                            <div className="col-span-4 text-caption font-bold text-muted-foreground uppercase tracking-widest">Account</div>
                            <div className="col-span-4 text-caption font-bold text-muted-foreground uppercase tracking-widest">Description</div>
                            <div className="col-span-2 text-caption font-bold text-muted-foreground uppercase tracking-widest text-right">Debit</div>
                            <div className="col-span-2 text-caption font-bold text-muted-foreground uppercase tracking-widest text-right">Credit</div>
                        </div>
                                ...
                                <div key={index} className="grid grid-cols-12 gap-4 items-start group">
                                    ...
                                    <div className="col-span-2">
                                        <input
                                            ...
                                            className="w-full px-3 py-2 bg-muted/50 border border-border rounded-lg text-body-sm text-right focus:ring-1 focus:ring-primary outline-none"
                                        />
                                    </div>
                    ...
                    <div className="flex items-center justify-between pt-6 border-t border-border">
                        <div className="flex items-center gap-6">
                            <div className="text-right">
                                ...
                                <p className="text-body-lg font-mono font-bold">₹{totalDebit.toLocaleString()}</p>
                            </div>
                            <div className="text-right">
                                <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Total Credit</p>
                                <p className="text-body-lg font-mono font-bold">₹{totalCredit.toLocaleString()}</p>
                            </div>
                            <div className={cn(
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                className="px-4 py-2 border border-border rounded-lg text-body-sm font-medium hover:bg-muted transition-colors"
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="flex items-center gap-1.5 px-6 py-2 bg-primary text-primary-foreground rounded-lg text-body-sm font-bold hover:bg-primary/90 transition-colors disabled:opacity-50"
                            >
