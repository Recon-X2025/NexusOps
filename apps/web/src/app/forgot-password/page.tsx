        ...
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-8 shadow-2xl backdrop-blur-sm">
          {sent ? (
            <div className="flex flex-col items-center gap-3 py-4">
              ...
              <h2 className="text-h4 font-semibold text-white">Check your email</h2>
              ...
              <Link
                href="/login"
                className="mt-4 flex items-center gap-2 text-body-sm text-indigo-400 hover:text-indigo-300"
              >
            ...
            <>
              <h2 className="mb-1 text-h4 font-semibold text-white">Reset password</h2>
              ...
              <Link
                href="/login"
                className="mt-6 flex items-center justify-center gap-2 text-body-sm text-indigo-400 hover:text-indigo-300"
              >
                <ArrowLeft className="h-4 w-4" />
                Back to sign in
              </Link>
