  ...
  return (
    <div className="sticky top-0 z-20 mb-5">
      <div className="rounded-xl bg-white border border-slate-200/90 shadow-sm dark:bg-slate-900/80 dark:border-slate-700 overflow-hidden">
        <div className="px-4 py-3 md:px-5 md:py-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <ExecutivePeriodSelect id="hub-range" value={rangeId} onChange={onRangeId} className="max-w-[min(100%,280px)]" />
            <button
              type="button"
              onClick={onRefresh}
        ...
        <div className="border-t border-slate-100 dark:border-slate-800 px-4 md:px-5">
          <nav className="-mb-px flex gap-6" role="tablist" aria-label="Hub sections">
            {tabs.map((t) => {
              ...
              return (
                <button
                  ...
                  onClick={() => onTab(t.id)}
                  className={cn(
                    "py-2.5 text-xs font-semibold border-b-2 -mb-px transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-sm",
                    active
