/** Knowledge (Seq 3 C4) — @see docs/QA_KNOWLEDGE_CATALOG_PORTAL_E2E_TEST_PACK.md */
...
test.describe("Knowledge (Seq 3 C4)", () => {
  test("P1 admin: /app/knowledge loads", async ({ page }) => {
    await loginAs(page, "admin@coheron.com");
    await expectNoRuntimeCrash(page, "/app/knowledge");
  });
});
