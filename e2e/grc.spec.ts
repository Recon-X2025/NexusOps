/** GRC (Seq 13 C4) — @see docs/QA_COMPLIANCE_E2E_TEST_PACK.md */
...
test.describe("GRC (Seq 13 C4)", () => {
  test("P1 admin: /app/grc loads", async ({ page }) => {
    await loginAs(page, "admin@coheron.com");
    await expectNoRuntimeCrash(page, "/app/grc");
  });
});
