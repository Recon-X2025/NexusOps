/** CSM (Seq 14 C4) — @see docs/QA_CSM_E2E_TEST_PACK.md */
...
test.describe("CSM (Seq 14 C4)", () => {
  test("P1 admin: /app/csm loads", async ({ page }) => {
    await loginAs(page, "admin@coheron.com");
    await expectNoRuntimeCrash(page, "/app/csm");
  });
});
