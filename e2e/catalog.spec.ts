/** Catalog (Seq 4 C4) — @see docs/QA_KNOWLEDGE_CATALOG_PORTAL_E2E_TEST_PACK.md */
...
test.describe("Catalog (Seq 4 C4)", () => {
  test("P1 admin: /app/catalog loads", async ({ page }) => {
    await loginAs(page, "admin@coheron.com");
    await expectNoRuntimeCrash(page, "/app/catalog");
  });
});
