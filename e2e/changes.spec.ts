/**
 * Change management — Playwright hero smoke (Seq 1 C4).
 * @see docs/QA_CHANGES_ITSM_E2E_TEST_PACK.md (CHG-TC-10)
 */
...
test.describe("Changes (Seq 1 C4)", () => {
  test("P1 admin: /app/changes loads", async ({ page }) => {
    await loginAs(page, "admin@coheron.com");
    await expectNoRuntimeCrash(page, "/app/changes");
  });
});
