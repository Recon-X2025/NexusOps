/** Security / SOC (Seq 12 C4) — @see docs/QA_SECURITY_ITSM_E2E_TEST_PACK.md */
...
test.describe("Security (Seq 12 C4)", () => {
  test("P1 admin: /app/security loads", async ({ page }) => {
    await loginAs(page, "admin@coheron.com");
    await expectNoRuntimeCrash(page, "/app/security");
  });
});
