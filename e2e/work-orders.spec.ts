/**
 * Work orders — Playwright hero smoke (Seq 2 C4).
 * @see docs/QA_WORK_ORDERS_ITSM_E2E_TEST_PACK.md (WO-TC-10 UI slice)
 */
...
test.describe("Work orders (Seq 2 C4)", () => {
  test("P1 admin: /app/work-orders and /app/work-orders/parts load", async ({ page }) => {
    await loginAs(page, "admin@coheron.com");
    await expectNoRuntimeCrash(page, "/app/work-orders");
