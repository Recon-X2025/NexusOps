...
CREATE TYPE "public"."ticket_status_category" AS ENUM('open', 'in_progress', 'resolved', 'closed');--> statement-breakpoint
...
CREATE TYPE "public"."walkup_appt_status" AS ENUM('booked', 'confirmed', 'completed', 'cancelled', 'no_show');--> statement-breakpoint
CREATE TYPE "public"."walkup_visit_status" AS ENUM('waiting', 'in_service', 'completed', 'no_show');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "walkup_appointments" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"org_id" uuid NOT NULL,
	"user_id" uuid NOT NULL,
	"location_id" uuid,
	...
	"status" "walkup_appt_status" DEFAULT 'booked' NOT NULL,
	"issue_category" text,
	"notes" text,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "walkup_visits" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"org_id" uuid NOT NULL,
	...
	"status" "walkup_visit_status" DEFAULT 'waiting' NOT NULL,
	"agent_id" uuid,
	"resolution" text,
	"csat_score" integer,
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "walkup_appointments" ADD CONSTRAINT "walkup_appointments_org_id_organizations_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "walkup_appointments" ADD CONSTRAINT "walkup_appointments_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "walkup_appointments" ADD CONSTRAINT "walkup_appointments_agent_id_users_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "walkup_visits" ADD CONSTRAINT "walkup_visits_org_id_organizations_id_fk" FOREIGN KEY ("org_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "walkup_visits" ADD CONSTRAINT "walkup_visits_visitor_id_users_id_fk" FOREIGN KEY ("visitor_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "walkup_visits" ADD CONSTRAINT "walkup_visits_agent_id_users_id_fk" FOREIGN KEY ("agent_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "tickets_idempotency_key_idx" ON "tickets" USING btree ("idempotency_key");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "walkup_appts_org_idx" ON "walkup_appointments" USING btree ("org_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "walkup_appts_scheduled_idx" ON "walkup_appointments" USING btree ("scheduled_at");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "walkup_visits_org_idx" ON "walkup_visits" USING btree ("org_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "walkup_visits_status_idx" ON "walkup_visits" USING btree ("org_id","status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "walkup_visits_created_at_idx" ON "walkup_visits" USING btree ("created_at");--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "tds_challan_records_month_year_idx" ON "tds_challan_records" USING btree ("month","year");